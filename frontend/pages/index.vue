<template>
    ...
    <div v-else-if="pageData">
        <router-link class="btn btn-sm btn-outline-success mb-2" :to="`/edit?page=index`" v-if="isAuthenticated" title="Редактировать страницу"><FontAwesomeIcon icon="pencil" /></router-link>
